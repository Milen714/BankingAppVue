...
<template>
  <section class="relative min-h-screen overflow-hidden bg-slate-100">
    ...
    <div class="absolute inset-x-0 top-0 h-72 bg-[radial-gradient(circle_at_top,_rgba(30,64,175,0.12),_transparent_58%)]"></div>
    ...
    <div class="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-blue-300/80 to-transparent"></div>
    ...
    <div class="relative mx-auto flex min-h-screen max-w-6xl items-center px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
      <div class="grid w-full items-center gap-6 md:gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:gap-10">
              ...
              <div class="rounded-[1.75rem] border border-slate-200 bg-white/90 p-5 shadow-sm">
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                      Designed for a clear sign-in flow
                    </p>
                  </div>
                  <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-blue-600 text-white shadow-lg shadow-blue-200">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                      <path d="M4 10L12 4l8 6v9a1 1 0 01-1 1H5a1 1 0 01-1-1v-9z" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <div class="mt-6 rounded-2xl bg-slate-950 px-5 py-5 text-white">
                  <div class="flex items-center justify-between gap-4">
                    ...
                    <div class="rounded-full bg-emerald-400/15 px-3 py-1 text-xs font-medium text-emerald-300">
                      Secure
                    </div>
                  </div>
              ...
              <div class="space-y-4">
                <div class="rounded-[1.75rem] border border-slate-200 bg-white/90 p-5 shadow-sm">
                  <div class="flex items-center gap-3">
                    <div class="flex h-10 w-10 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-700">
                      <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                        <path d="M12 3l7 4v5c0 4.4-2.9 8.5-7 9-4.1-.5-7-4.6-7-9V7l7-4z" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M9.5 12.5l1.8 1.8 3.7-4.1" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </div>
                    <div>
                      <p class="text-sm font-semibold text-slate-900">
                ...
                <div class="rounded-[1.75rem] border border-slate-200 bg-white/90 p-5 shadow-sm">
                  ...
                  <p class="mt-2 text-sm leading-6 text-slate-600">
                    Use the password link on the form or create an account if you are new to online banking.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="relative w-full max-w-lg justify-self-center animate-[fade-in_450ms_ease-out]">
          ...
          <div class="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.12)] sm:rounded-[2rem]">
            ...
            <div class="mb-8">
              <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="rounded-2xl border border-emerald-200 bg-emerald-50 px-3 py-2 text-right sm:block lg:hidden">
            ...
            <div class="mb-6 flex items-center gap-3 rounded-2xl bg-slate-50 px-4 py-3 text-sm text-slate-600">
              <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-white text-slate-700 shadow-sm">
                <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path d="M12 16v.01M7 10V8a5 5 0 1110 0v2m-9 0h8a1 1 0 011 1v7a1 1 0 01-1 1H8a1 1 0 01-1-1v-7a1 1 0 011-1z" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </div>
            ...
            <form class="space-y-5" novalidate @submit.prevent="handleSubmit">
              ...
              <p
                ...
                :class="statusType === 'success' ? 'border-emerald-200 bg-emerald-50 text-emerald-700' : 'border-rose-200 bg-rose-50 text-rose-700'"
              >
                {{ statusMessage }}
              </p>
            </form>

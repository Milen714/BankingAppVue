...
<template>
  <aside class="hidden w-[250px] shrink-0 border-r border-slate-200 bg-[#f5f6f7] md:flex md:flex-col">
    <div class="border-b border-slate-200 px-5 py-5">
      <p class="text-2xl font-semibold text-slate-900">Customer Portal</p>
